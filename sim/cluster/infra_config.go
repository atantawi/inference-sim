...
// effectiveDrainPolicy returns the drain policy name, defaulting to WAIT.
func (c *InstanceLifecycleConfig) effectiveDrainPolicy() DrainPolicyName {
	if c.DrainPolicy == "" {
		return DrainPolicyWait
	}
	return DrainPolicyName(c.DrainPolicy)
}
